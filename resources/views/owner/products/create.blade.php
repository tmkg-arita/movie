                ...
                <form method="post" action="{{ route('owner.products.store')}}" >
                    ...
                    <div class="-m-2">
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                          <label for="name" class="leading-7 text-sm text-gray-600">商品名 <span class="text-red-600">※必須</span></label>
                      ...
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                          <label for="information" class="leading-7 text-sm text-gray-600">商品情報 <span class="text-red-600">※必須</span></label>
                      ...
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                          <label for="price" class="leading-7 text-sm text-gray-600">価格 <span class="text-red-600">※必須</span></label>
                      ...
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                          <label for="quantity" class="leading-7 text-sm text-gray-600">初期在庫 <span class="text-red-600">※必須</span></label>
                      ...
                      <div class="p-2 w-full flex justify-around mt-4">
                        ...
                        <button type="submit" class="text-garay bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">登録する</button>
                      </div>
                    </div>
                  </form>
              </div>
