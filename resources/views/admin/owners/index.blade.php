      ...
      <table class="table-auto w-full text-left whitespace-no-wrap">
        ...
        @foreach ($owners as $owner )
            <tr>
                ...
                <td class="px-4 py-3">
                <button onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id]) }}'" class="text-white bg-blue-400 border-0 py-1 px-1 focus:outline-none hover:bg-blue-500 rounded">編集</button>
                </td>
            </tr>
        @endforeach
        </tbody>
